...
// .wrangler/tmp/bundle-RkXANs/checked-fetch.js
...
// .wrangler/tmp/bundle-RkXANs/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-RkXANs/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.put("api/v1/blog", (c) => {
  return c.text("Blog putting route");
});
app.get("/api/v1/blog/:id", (c) => {
  return c.text("Blog getting route");
});
